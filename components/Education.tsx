    ...
    return (
        <div className="mb-20 px-6" id="education">
            ...
            <p className="my-2 mb-6">
                A collection of my academic history and achievements. For more information, visit my{' '}
            <a
            ...
            longDescription="I am a proud UCF Knight, and a proud member of the Burnett Honors College. During my time at UCF thus far, I have gotten involved with various extracurriculars and registered student organizations to immerse myself in the industry. In my following semesters, I make it a goal of mine to gain experience by getting involved in research and internships, as well as continue to remain in good standing with the organizations I am involved with."></EducationItem>
            <EducationItem
            ...
            extracurriculars={["Bob Elmore Honors College", "inTech Software Development Club", "Competitive Programming Competitions"]}
